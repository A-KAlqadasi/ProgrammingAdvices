...
namespace _23_DataViewFiltering
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine($"{EmployeesDataView1[i]["ID"]}, {EmployeesDataView1[i][1]}, {EmployeesDataView1[i][2]}, " +
                    $"{EmployeesDataView1[i][3]}, {EmployeesDataView1[i][4]}");
            }

            // this is how to filter dataview
            EmployeesDataView1.RowFilter = "Country in('Yemen','Jordan')";

            Console.WriteLine("\n\nEmployees list from data view after filtering \"Yemen\" or \"Jordan\"\n");
