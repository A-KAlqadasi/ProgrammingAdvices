      ...
      private void _FillCountriesInComoboBox()
        ...
        private void _LoadData()
        {
           ...
           _Contact = clsContact.Find(_ContactID);
            ...
            dtpDateOfBirth.Value = _Contact.Birthdate;
            ...
            cbCountry.SelectedIndex = cbCountry.FindString(clsCountry.FindCountry(_Contact.CountryID).CountryName);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _Contact.Birthdate=dtpDateOfBirth.Value;
