...
namespace StudentDataAccessLayer
{
    ...
    {
        static string _connectionString = "Server=Abu-Ghaith\\AMSSQLSERVER;Database=StudentsDB;User Id=sa;Password=isa123456;Encrypt=False;TrustServerCertificate=True;Connection Timeout=30;";
