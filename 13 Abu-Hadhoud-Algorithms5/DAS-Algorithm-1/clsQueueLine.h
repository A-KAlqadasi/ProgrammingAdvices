#pragma once
#include<iostream>
#include<queue> // STL library , Stracture template library
#include<stack>
#include "clsDate.h"
#include<iomanip>
...
private:
	...
	public:
		...
		clsTicket(string prefix, short number, short waitingClients, short serveTime)
		{
			_Number = number;
			_Prefix = prefix;
